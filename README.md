...
> Forked or freshly downloaded copy? Start with [`FORK_SETUP.md`](./FORK_SETUP.md) to recreate the ignored local env files and reconnect Vercel/Render/Supabase settings.
