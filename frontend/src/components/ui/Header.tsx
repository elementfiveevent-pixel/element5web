...
export const Header: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b-3 border-[#121212] bg-[#121212]/97 backdrop-blur-md relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3.5 flex items-center justify-between gap-3 sm:gap-6">

        {/* Logo */}
        <Link
          href="/"
          className="font-display font-extrabold text-lg sm:text-xl tracking-tighter hover:text-yellow-festival transition-colors flex items-center gap-2 flex-shrink-0 whitespace-nowrap"
        >
          ELEMENT 5
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="lg:hidden w-11 h-11 border-2 border-[#FAF8F5]/20 rounded text-[#FAF8F5] hover:border-yellow-festival transition-colors flex items-center justify-center"
      ...
      {/* ── Mobile drawer ─────────────────────────────────────────────────── */}
      {mobileOpen && (
        <div id="mobile-navigation" className="lg:hidden absolute top-full inset-x-0 bg-[#0F0E0E] border-t-2 border-[#FAF8F5]/10 px-4 pb-6 pt-4 space-y-3 max-h-[calc(100dvh-4.5rem)] overflow-y-auto shadow-[0_12px_24px_rgba(0,0,0,0.35)]">
