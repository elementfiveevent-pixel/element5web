    ...
    <div className="min-h-screen bg-[#FFF5E4] text-[#121212] py-10 sm:py-16 px-4 sm:px-8">
      <div className="max-w-3xl mx-auto space-y-6 sm:space-y-8">
        ...
        <div className="space-y-6">
          ...
          <div className="border-3 border-[#121212] bg-white p-4 sm:p-6 rounded shadow-brutal space-y-4">
          ...
          <div className="border-3 border-[#121212] bg-[#FFDE4D]/10 p-4 sm:p-6 rounded shadow-brutal space-y-4">
            <div className="flex items-center gap-3">
