...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FFF5E4] text-[#121212] py-10 sm:py-16 px-4 sm:px-8">
      <div className="max-w-4xl mx-auto space-y-8 sm:space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
          ...
          {/* Left Column: Form */}
          <div className="md:col-span-7 border-3 border-[#121212] bg-white p-4 sm:p-6 rounded shadow-brutal space-y-4">
          ...
          <div className="md:col-span-5 space-y-4">
            ...
            {/* Social channels */}
            <div className="border-3 border-[#121212] bg-yellow-festival/10 p-4 sm:p-6 rounded shadow-brutal space-y-3">
